package com.poc.pamport.postgres.auth;
...
import com.poc.pamport.postgres.PostgresEngine;
...
public final class PgGssBackend {
    ...
    private static SslContext buildSslContext(PostgresEngine.Route route) throws Exception {
    ...
    private static class BackendHandshakeHandler extends ChannelInboundHandlerAdapter {
        ...
        private Subject loginWithRoute(PostgresEngine.Route route) {
            try {
        ...
        private static ByteBuf buildStartupMessage(ChannelHandlerContext ctx, PostgresEngine.Route route) {
