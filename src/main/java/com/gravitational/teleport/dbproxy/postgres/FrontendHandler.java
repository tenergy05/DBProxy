...
import com.gravitational.teleport.dbproxy.core.MessagePump;
...
import com.gravitational.teleport.dbproxy.core.audit.Query;
    ...
    private void maybeConnect(ChannelHandlerContext ctx) {
        ...
        connector = new BackendConnector(hp.host(), hp.port(), frontendChannel -> new ChannelInitializer<SocketChannel>() {
            ...
            protected void initChannel(SocketChannel backendCh) {
                ...
                backendCh.pipeline().addLast("backendHandler", new com.gravitational.teleport.dbproxy.core.BackendHandler(frontendChannel));
            }
        });
